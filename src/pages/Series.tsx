...
//         processedData = filterByProgramType(processedData, "series");

//         // Extraer años únicos antes de filtrar por año específico
//         const uniqueYears = [
//           ...new Set(processedData.map((entry) => entry.releaseYear)),
//         ].sort((a, b) => b - a);
//         setYears(uniqueYears); // Guardamos todos los años antes de filtrar

//         // Filtrar por año si hay uno seleccionado
//         if (selectedYear) {
//           processedData = filterByReleaseYear(processedData, selectedYear);
//         }

//         // processedData = filterByReleaseYear(processedData, 2010);
//         processedData = sortByTitle(processedData);
//         processedData = getFirstNEntries(processedData, resultsPerPage);
...
//           <ResultsPerPage onResultsPerpage={onResultsPerpage} currentQuantity={resultsPerPage}/>
